 ...
 * for account blockage operation.
 * @author Baranovsky E. K.
 * @version 1.0.0
 */
public class AccountLockCommand extends AbstractOperationCommand{

    private static final String SQL_INSERT_OPERATION = String.format(
            "INSERT INTO %s (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) VALUES (DEFAULT, NULL, 1, ?, NULL, NULL, NULL, NULL, ?, NOW())",
     ...
     *     accountId field (changes status to locked).
     * </p>
